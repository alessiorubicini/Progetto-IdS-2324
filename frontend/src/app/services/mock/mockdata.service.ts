...
export class MockdataService {
	...
	public static getAllPointsMocks() : Point[] {
		return [
			...
			{ id: 5, name: "Tourism", description: "Explore enchanting landmarks, vibrant culture, and hidden gems in our city's Tourism hub. Unforgettable experiences await!", imageUrl: "https://st4.depositphotos.com/16470190/25651/v/450/depositphotos_256510820-stock-illustration-planning-travel-with-online-services.jpg", cityId: 2 },
